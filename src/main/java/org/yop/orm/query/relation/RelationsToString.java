...
class RelationsToString {
	 ...
	 */
	static <From extends Yopable, To extends Yopable> String from(Map<From, Collection<To>> relations) {
	 ...
	 */
	static <From extends Yopable, To extends Yopable> String to(Map<From, Collection<To>> relations) {
	 ...
	 */
	static <From extends Yopable, To extends Yopable> String toString(Map<From, Collection<To>> relations) {
