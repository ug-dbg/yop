...
public class SuperExtra implements Yopable {
	...
	private java.sql.Timestamp sqlTimestamp = new Timestamp(System.currentTimeMillis());

	@Column(name ="sqltime_timestamp", transformer = FallbackTransformer.class)
	private java.sql.Time sqlTime = new java.sql.Time(System.currentTimeMillis());
